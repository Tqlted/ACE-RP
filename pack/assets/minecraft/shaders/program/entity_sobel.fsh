...
#define COLOR_RTP_YELLOW vec3(255./255., 254./255., 0./255.)
#define COLOR_RTP_GREEN vec3(0./255., 254./255., 0./255.)
...
void main(){
    ...
    } else if (baseColor == COLOR_RTP_YELLOW) {
        fragColor = vec4(vec3(1), 0.13);
        return;
    } else if (baseColor == COLOR_RTP_GREEN) {
        fragColor = vec4(vec3(169./255., 0, 169./255.), 0.11);
        return;
    }
